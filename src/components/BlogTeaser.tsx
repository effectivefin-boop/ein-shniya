...
const posts = [
  ...
  {
    slug: "checkup-vs-advice",
    title: "בדיקה זה לא ייעוץ — וזה בסדר",
    excerpt:
      "מה עין שנייה כן עושה, מה היא לא עושה, ומתי כדאי לדבר עם בעל רישיון.",
    tag: "אמון",
  },
];
        ...
        <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
          <div className="max-w-2xl">
            ...
            <p className="mt-3 text-base text-text-muted sm:text-lg">
              הסברים קצרים על פערים ששווה להבין — בלי לשווק מוצרים.
            </p>
          </div>
          <Link
            href="/blog"
