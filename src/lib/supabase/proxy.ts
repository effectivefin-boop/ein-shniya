...
/**
 * Refresh Supabase auth cookies and gate /admin/* (except login).
...
export async function updateSession(request: NextRequest) {
  ...
  // Soft-skip if env not configured yet (local before keys arrive)
  if (!url || !anon) {
  ...
  // Logged-in admin hitting login → go to leads
